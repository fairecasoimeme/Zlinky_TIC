...
tsZHA_BaseDevice sBaseDevice __attribute__((section(".bss.discard.app")));
uint32_t U32UTCTimeBeforeSleep;
...
static bool_t bOnOffStatePersist = FALSE;

/****************************************************************************
 *
 * NAME: APP_ZCL_vStartTimers
 *
 * DESCRIPTION:
 *
 *
 ...
 *
 ****************************************************************************/
PUBLIC void APP_vHandleIdentify(uint16_t u16Time)
{
