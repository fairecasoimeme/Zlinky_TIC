...
#define BOARD_LED_PORT BOARD_LED_USB_DONGLE1_GPIO_PORT
#define BOARD_LED_PIN BOARD_LED_USB_DONGLE1_GPIO_PIN
#define BOARD_LED2_PORT BOARD_LED_USB_DONGLE2_GPIO_PORT
#define BOARD_LED2_PIN BOARD_LED_USB_DONGLE2_GPIO_PIN
